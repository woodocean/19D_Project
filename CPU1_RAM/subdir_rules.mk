...
build-1711584945: ../new.syscfg
	@echo 'Building file: "$<"'
	@echo 'Invoking: SysConfig'
	"D:/ti/ccs1210/ccs/utils/sysconfig_1.14.0/sysconfig_cli.bat" -s "D:/ti/c2000/C2000Ware_4_00_00_00/.metadata/sdk.json" -d "F2837xD" --script "D:/ti/CCS_workspace/adc_soc_multiple_epwm/new.syscfg" -o "syscfg" --compiler ccs
	@echo 'Finished building: "$<"'
	@echo ' '

syscfg/board.c: build-1711584945 ../new.syscfg
syscfg/board.h: build-1711584945
syscfg/pinmux.csv: build-1711584945
syscfg/adc.dot: build-1711584945
syscfg/: build-1711584945
